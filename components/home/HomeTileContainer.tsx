...
const tiles = [
    ...
    { title: 'Expand your playlists with your own taste', content: 'Get personalized recommendations based on your recently listened songs, or your all-time favorites.', img: 'tile-three', icon: 'recommendations', path: '/explore', buttonText: 'Get recommendations' }
]
